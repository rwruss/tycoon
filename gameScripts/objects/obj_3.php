...
factoryDiv.headSection.rate = textBlob("", factoryDiv.headSection, "Rate: " + (selFactory.currentRates[2]/100).toFixed(2) + " <br>Lifetime Earnings: $'.($thisObj->get('totalSales')/100).'<br>Period Earnings: $'.($thisObj->get('periodSales')/100).'");
