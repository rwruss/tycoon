...
// Options for speeding up production at a factory
...
boostButton1 = newButton(boostListHolder, function () {scrMod("1038,'.$postVals[2].',0");});
boostButton1.innerHTML = "1 minute";

boostButton2 = newButton(boostListHolder, function () {scrMod("1038,'.$postVals[2].',1");});
boostButton2.innerHTML = "10 minutes";

boostButton3 = newButton(boostListHolder, function () {scrMod("1038,'.$postVals[2].',2"););
boostButton3.innerHTML = "30 minutes";

boostButton3 = newButton(boostListHolder, function () {scrMod("1038,'.$postVals[2].',3");});
